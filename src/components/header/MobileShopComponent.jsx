...
function MobileShopComponent({ catigory, closeDrawer }) {
  let withoutSubs = [];
              ...
              return (
                <Accordion radius={"sm"} key={subCat.name}>
                  <Accordion.Item value={subCat.name} className="border-b-0">
                    <Accordion.Control
                      className="h-8 "
                      classNames={{ control: "data-[active=true]:bg-gray-50" }}
                    >
                      ...
                      {subCat?.categories
                        .filter((cat) => {
                          if (
                            ...
                            return !menGetInspiredUnwantedCats.includes(
                              cat.name
                            );
                          } else if (
                        ...
                        .map((subCat) => (
                          <Link
                            ...
                            className="block hover:underline text-[15px]"
                            key={subCat.name}
                          >
                            {subCat.name}
                          </Link>
