    ...
    <div>
      <div className="my-7 flex justify-between items-center">
        ...
        <div className="flex items-center">
          ...
          />
          <Button
            className="bg-black text-white rounded-3xl h-12 w-40"
            onClick={() => {
  ...
  <Menu shadow="md" width={200}>
    <Menu.Target>
      <Button
        ...
        rightSection={
          <IconChevronDown className="text-gray-800 absolute right-4" />
        }
      >
    ...
    <Menu.Dropdown>
      ...
      <Menu.Item
        className={filterType == "SubmissionTime" && "bg-gray-200"}
        onClick={() => {
          setFilterType("SubmissionTime");
          setReviews([]);
        }}
      >
        Submition Time
      ...
      <Menu.Item
        className={filterType == "Rating" && "bg-gray-200"}
        onClick={() => {
      ...
      <Menu.Item
        className={filterType == "Helpfulness" && "bg-gray-200"}
        onClick={() => {
          setFilterType("Helpfulness");
          setReviews([]);
        }}
      >
        Helpfulness
...
const Settings = ({ sort, setSort, setReviews, setFilterType, filterType }) => {
  ...
  return (
    <Menu shadow="md" width={200}>
      <Menu.Target>
        <ActionIcon
          className={`bg-gray-100 p-3 rounded-full h-auto w-auto ${
            matches && "mr-3"
          }`}
        >
          <img src={filter} alt="" />
      ...
      <Menu.Dropdown>
        ...
        <Menu.Item
          className={sort == "desc" && "bg-gray-200"}
          onClick={() => {
            sort != "desc" && setReviews([]);
            setSort("desc");
          }}
        >
          Descending
        ...
        <Menu.Item
          className={sort == "asc" && "bg-gray-200"}
          onClick={() => {
            sort != "asc" && setReviews([]);
            setSort("asc");
          }}
